...
from data.cifar import CIFAR10, CIFAR100, CIFAR20
...
def get_training_dataloader(dataset_name, mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    if dataset_name == 'cifar100':
        cifar_training = CIFAR100(root='./data', train=True, download=True, transform=transform_train)
    elif dataset_name == 'cifar10':
        cifar_training = CIFAR10(root='./data', train=True, download=True, transform=transform_train)
    elif dataset_name == 'cifar20':
        cifar_training = CIFAR20(root='./data', train=True, download=True, transform=transform_train)
    else:
        NotImplementedError()
...
def get_test_dataloader(dataset_name, mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    if dataset_name == 'cifar100':
        cifar_test = CIFAR100(root='./data', train=False, download=True, transform=transform_test)
    elif dataset_name == 'cifar10':
        cifar_test = CIFAR10(root='./data', train=False, download=True, transform=transform_test)
    elif dataset_name == 'cifar20':
        cifar_test = CIFAR20(root='./data', train=False, download=True, transform=transform_test)
    else:
        NotImplementedError()
